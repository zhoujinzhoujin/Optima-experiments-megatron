...
from megatron.mpu.mappings import scatter_to_sequence_parallel_region
...
class Llama2ParallelAttention(MegatronModule):
    ...
    def __init__(self, init_method,
        ...
        world_size = initialize.get_tensor_model_parallel_world_size()
...
class Llama2ParallelTransformer(MegatronModule):
    ...
    def __init__(self, init_method, output_layer_init_method,
        ...
        # Number of layers.
        assert args.num_layers % initialize.get_pipeline_model_parallel_world_size() == 0, \
            'num_layers must be divisible by pipeline_model_parallel_size'
        self.num_layers = args.num_layers // initialize.get_pipeline_model_parallel_world_size()
        ...
        if args.virtual_pipeline_model_parallel_size is not None:
            ...
            offset = initialize.get_pipeline_model_parallel_rank() * self.num_layers
